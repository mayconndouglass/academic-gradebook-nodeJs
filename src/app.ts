...
import { absencesRoutes } from "./http/controllers/absence/routes"
import { subjectSchedulesRoutes } from "./http/controllers/subject-schedules/routes"
...
app.register(absencesRoutes)
app.register(subjectSchedulesRoutes)
